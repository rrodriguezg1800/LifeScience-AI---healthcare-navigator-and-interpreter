...
let DefaultContextManager;
let DefaultPropagator;
...
export function setupTracer(config = {}) {
    ...
    if (DefaultContextManager)
        otelContext.setGlobalContextManager(new DefaultContextManager());
    if (DefaultPropagator)
        propagation.setGlobalPropagator(DefaultPropagator);
