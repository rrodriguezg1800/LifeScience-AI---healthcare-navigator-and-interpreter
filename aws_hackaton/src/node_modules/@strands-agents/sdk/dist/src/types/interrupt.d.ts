 ...
 * ```
 */
export declare class InterruptResponseContent implements InterruptResponseContentData, JSONSerializable<InterruptResponseContentData> {
    /**
 ...
 * @internal
 */
export declare function isInterruptResponseContent(value: unknown): value is InterruptResponseContent;
