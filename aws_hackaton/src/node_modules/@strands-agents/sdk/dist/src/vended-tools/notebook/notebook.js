...
const notebookInputSchema = z
    ...
    insertLine: z
        ...
        .optional()
        .describe('Line number (int) or search text (str) for insertion point in write mode.\nSupports negative indices.'),
})
    .refine((data) => {
    ...
    message: 'Write operation requires either (oldStr + newStr) for replacement or (insertLine + newStr) for insertion',
});
/**
...
export const notebook = tool({
    ...
    callback: (input, context) => {
        ...
        let notebooks = context.agent.appState.get('notebooks');
        if (!notebooks) {
            notebooks = {};
        }
 ...
 */
function handleCreate(notebooks, name, newStr) {
 ...
 */
function handleRead(notebooks, name, readRange) {
 ...
 */
function handleClear(notebooks, name) {
