 ...
 */
export declare const stateToJSONSymbol: unique symbol;
/**
 * Symbol for the deserialization method on StateSerializable objects.
 */
export declare const loadStateFromJSONSymbol: unique symbol;
/**
 ...
 */
export declare function serializeStateSerializable(obj: StateSerializable): JSONValue;
/**
 ...
 */
export declare function loadStateSerializable(obj: StateSerializable, json: JSONValue): void;
