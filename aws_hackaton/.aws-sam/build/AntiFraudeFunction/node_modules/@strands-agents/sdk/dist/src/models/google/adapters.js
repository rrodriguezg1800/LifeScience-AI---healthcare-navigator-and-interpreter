 ...
 */
import { FunctionResponse, FinishReason as GeminiFinishReason, } from '@google/genai';
 ...
 * @internal
 */
function formatContentBlock(block, toolUseIdToName) {
    switch (block.type) {
        case 'textBlock':
 ...
 * @internal
 */
function formatReasoningBlock(block) {
    if (!block.text) {
        return [];
    }
    const part = {
 ...
 * @internal
 */
function formatVideoBlock(block) {
 ...
 * @internal
 */
function formatToolResultBlock(block, toolUseIdToName) {
    const parts = [];
    const output = [];
 ...
 * @internal
 */
export function mapChunkToEvents(chunk, streamState) {
    const events = [];
