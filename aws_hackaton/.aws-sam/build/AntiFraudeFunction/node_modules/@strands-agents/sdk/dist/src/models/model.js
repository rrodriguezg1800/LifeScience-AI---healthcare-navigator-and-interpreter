...
export class Model {
    ...
    estimateUtilization(inputTokens) {
        ...
        if (!contextWindowLimit) {
            ...
            warnOnce(logger, `contextWindowLimit is not set on the model, using default of ${DEFAULT_CONTEXT_WINDOW_LIMIT} for utilization estimate | set contextWindowLimit in your model config for accurate results`);
        }
