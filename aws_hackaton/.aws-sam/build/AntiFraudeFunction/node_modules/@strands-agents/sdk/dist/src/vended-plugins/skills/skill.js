...
function parseFrontmatter(content) {
    ...
    const frontmatter = typeof result === 'object' && result !== null ? result : {};
 ...
 */
function validateSkillName(name, dirPath, options) {
 ...
 */
function buildSkillFromFrontmatter(frontmatter, body, path) {
...
export class Skill {
     ...
     */
    static fromFile(skillPath, options) {
     ...
     */
    static fromDirectory(skillsDir, options) {
