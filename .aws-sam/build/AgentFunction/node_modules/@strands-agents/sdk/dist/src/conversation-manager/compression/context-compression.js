 ...
 */
export function adjustSplitPointForToolPairs(messages, splitPoint) {
 ...
 */
export function findValidTrimPoint(messages, startIndex) {
 ...
 * - 'all': always matches
 */
export function matchesMessageType(message, filter) {
    if (filter === 'all')
        return true;
