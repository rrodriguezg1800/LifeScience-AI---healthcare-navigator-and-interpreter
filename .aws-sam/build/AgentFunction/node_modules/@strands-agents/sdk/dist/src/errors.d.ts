 ...
 */
export declare class ContextWindowOverflowError extends ModelError {
    /**
 ...
 */
export declare class MaxTokensError extends ModelError {
    /**
 ...
 */
export declare class ModelThrottledError extends ModelError {
    /**
 ...
 */
export declare function serializeError(error: Error): JSONValue;
/**
 ...
 */
export declare class ProviderTokenCountError extends ModelError {
    constructor(message: string, options?: {
        cause?: unknown;
    });
}
 ...
 */
export declare class DefaultNotConfiguredError extends Error {
    constructor(message: string);
}
/**
