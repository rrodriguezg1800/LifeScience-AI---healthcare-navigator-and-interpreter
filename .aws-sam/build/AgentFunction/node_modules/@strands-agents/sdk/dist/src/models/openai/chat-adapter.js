 ...
 * @internal
 */
export function formatChatRequest(config, messages, options) {
 ...
 * @internal
 */
export function mapChatChunkToEvents(chunk, state, activeToolCalls) {
    const events = [];
    ...
    if (delta?.role && !state.messageStarted) {
        ...
        events.push({ type: 'modelMessageStartEvent', role: delta.role });
    }
