 ...
 */
const sessionFinalizer = new FinalizationRegistry((session) => {
    session.stop();
});
/**
 ...
 * ```
 */
const DEFAULT_DESCRIPTION = 'Executes bash shell commands in a persistent session. Supports execute and restart modes. ' +
