...
export const JUDGE_OUTCOME_SCHEMA = z.object({
    ...
    feedback: z
        .string()
        .optional()
        .describe('Required when passed is false. Name the specific unmet part of the goal and the concrete change needed to ' +
 ...
 */
export function buildJudgePrompt(description, transcript) {
        ...
        const parts = message.content.flatMap((block) => {
            ...
            if (block.type === 'toolResultBlock') {
                const text = block.content
                    .flatMap((inner) => inner.type === 'textBlock' ? [inner.text] : inner.type === 'jsonBlock' ? [JSON.stringify(inner.json)] : [])
                    .join(' ');
