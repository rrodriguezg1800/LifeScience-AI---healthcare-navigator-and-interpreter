import { BeforeInvocationEvent, BeforeToolCallEvent, AfterToolCallEvent, BeforeModelCallEvent, AfterModelCallEvent, } from '../hooks/events.js';
...
export class InterventionRegistry {
    _handlers;
    constructor(handlers, hookRegistry) {
        const seen = new Set();
    ...
    async _onBeforeInvocation(event) {
    ...
    async _onBeforeModelCall(event) {
    ...
    _handleError(handler, method, error) {
